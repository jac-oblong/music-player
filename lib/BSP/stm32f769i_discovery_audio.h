...
/** @defgroup STM32F769I_DISCOVERY_AUDIO_Exported_Types
...
/** @defgroup STM32F769I_DISCOVERY_AUDIO_Exported_Constants
...
/*------------------------------------------------------------------------------
 ...
 -----------------------------------------------------------------------------*/
/** CODEC_AudioFrame_SLOT_TDMMode In W8994 codec the Audio frame contains 4
 * slots : TDM Mode TDM format :
 * +------------------|------------------|--------------------|-------------------+
 * | CODEC_SLOT0 Left | CODEC_SLOT1 Left | CODEC_SLOT0 Right  | CODEC_SLOT1
 * Right |
 * +------------------------------------------------------------------------------+
 */
/* To have 2 separate audio stream in Both headphone and speaker the 4 slot must
 * be activated */
#define CODEC_AUDIOFRAME_SLOT_0123                                             \
  SAI_SLOTACTIVE_0 | SAI_SLOTACTIVE_1 | SAI_SLOTACTIVE_2 | SAI_SLOTACTIVE_3

/* To have an audio stream in headphone only SAI Slot 0 and Slot 2 must be
 * activated */
#define CODEC_AUDIOFRAME_SLOT_02 SAI_SLOTACTIVE_0 | SAI_SLOTACTIVE_2
/* To have an audio stream in speaker only SAI Slot 1 and Slot 3 must be
 * activated */
...
#define OUTPUT_DEVICE_HEADPHONE2                                               \
  OUTPUT_DEVICE_SPEAKER /* Headphone2 is connected to Speaker output of the    \
                           wm8994 */
...
/** @defgroup STM32F769I_DISCOVERY_AUDIO_Exported_Macros
...
/** @defgroup STM32F769I_DISCOVERY_AUDIO_OUT_Exported_Functions
...
/** @defgroup STM32F769I_DISCOVERY_AUDIO_IN_Exported_Functions
 * STM32F769I_DISCOVERY_AUDIO_IN Exported Functions
 * @{
 */
uint8_t BSP_AUDIO_IN_Init(uint32_t AudioFreq, uint32_t BitRes,
                          uint32_t ChnlNbr);
...
/* This function should be implemented by the user application.
   It is called into this driver when the current buffer is filled to prepare
   the next buffer pointer and its size. */
